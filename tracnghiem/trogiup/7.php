...
<div class="container-fluid" style="background-color:beige">
    ...
    <div class="row">
            ...
            <div class="content4" style="padding-left:20px;padding-top:10px;padding-right:20px;height:800px;font-size:20px">
                <label>--Xoá sinh viên--</label>
                <br>
                <label>1. Nhấp chuột vào sinh viên cần xoá</label>
                <br>
                <label>2. Thông tin sinh viên sẽ hiện vào ô tương ứng</label>
                <br>
                <label>3. Nhấp vào xoá và xác nhận</label>
                <br>
            </div>
    </div>
