			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="https://utt.edu.vn/uploads/images/site/1684312014banner-2023.png" class="img-thumbnail" style="background-color:bisque" class="brand_logo" alt="Logo" width="500px"hight="20px;">
