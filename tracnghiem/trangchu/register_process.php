...
if ( $_SERVER[ 'REQUEST_METHOD' ] == 'POST' ) {
    ...
    if ( $check_username_result->num_rows > 0 ) {
        ...
        $insert_user_query = "INSERT INTO users (username, password, role) VALUES ('$username', '$hashed_password', '$role')";
            ...
            <div class='user_card'>
                <div class='d-flex justify-content-center'>
                    <div class='brand_logo_container'>
                        <img src='https://utt.edu.vn/uploads/images/site/1684312014banner-2023.png' class='brand_logo'
                            alt='Logo' width='500px' hight='20px;'>
