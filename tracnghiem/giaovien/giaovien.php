    ...
    <div class="container-fluid" style="background-color:beige">
        ...
        <div class="row">
            ...
            <div class="content2" style="padding-left:100px">
                <form method="get" action="timkiemgv.php">
                    <br>
                    <h1 style="color:chocolate; text-align: center;width:px;font-weight: bold;">Thông tin giáo viên</h1>
                    <br>
                    <div class="col-sm-12 text-right">
                        <input style="background-color:coral;" class="btn btn-success" type="submit" value="Tìm Kiếm">
                    </div>
                </form>
                        ...
                        <tr>
                            <td colspan="5" class="col-sm-12 text-right">
                                ...
                                <button style="background-color:darkblue;border:1px ridge darkblue;" type="button"
                                    class="btn btn-primary" data-toggle="modal" data-target="#myModal">Thêm giáo
                                    viên</button>
                            </td>
                        </tr>
                        <?php
...
//cau lenh
$sql = "SELECT * FROM teachers order by name, email, subject, phone LIMIT $start, $limit";
//thuc thi cau lenh
...
while ( $r = mysqli_fetch_assoc( $result ) ) {
    ...
    ?></td>
                            <td><?php echo $r[ "email" ];
    ?></td>
                            <td><?php echo $r[ "subject" ];
    ?></td>
                            <td><?php echo $r[ "phone" ];
    ?></td>
                            <td><a href="editgv.php?sid=<?php echo $r['id'];?>" class="btn btn-info">Sửa</a>&nbsp;
                                <a onclick="return confirm('Bạn có muốn xoá không?');"
                                    href="xoagv.php?sid=<?php echo $r['id'];?>" class="btn btn-danger">Xoá</a>
                            </td>
                        </tr>
                        <?php
}
...
for ( $i = 1; $i <= $total_pages; $i++ ) {
    ...
    echo "<li class='page-item'> <a class='page-link' href='giaovien.php?page=" . $i . "'>" . $i . '</a></li>';
    echo "</ul>";
}
?>
                    </tbody>
                ...
                <div class='modal-dialog'>
                    <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                            <div class='conteiner' style='background-color:bisque'>
                                <h1 style='color: red' , style='text-align: center'>Nhập thông tin giáo viên</h1>
