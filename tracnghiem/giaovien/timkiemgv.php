...
<body>
        ...
        <div class="row">
            <div class="menu_left1">
                <div class="list-group">
                    ...
                    <div class="collapse" id="target2">
                        <a href="../giaovien/giaovien.php" style="background:bisque;color:crimson" class="list-group-item"><i
                                style="font-size:25px;" class="fa-solid fa-user-tie"></i> Quản lý giáo viên</a>
            ...
            <div class="content2" style="padding-left:100px">
                <form method="get" action="">
                    <br>
                    <h1 style="color:chocolate; text-align: center;width:px;font-weight: bold;">Tìm kiếm thông tin giáo
                        viên</h1>
                    <br>
                    <div class="form-inline">
                        ...
                        <input style="width: 400px;font-size:16px" type="text" class="form-control"
                            placeholder="Tìm kiếm theo thông tin giáo viên" name="search"
                            value="<?php if(isset($_GET["search"])){echo $_GET["search"];}?>">&nbsp;&nbsp;&nbsp;
                        <input style="background-color:coral;font-size:14px" class="btn btn-success" type="submit"
                            value="Tìm Kiếm">
                    </div>
                </form>
                <br>
    ...
    if(isset($_GET["search"]) && !empty($_GET["search"])){
        $key=$_GET["search"];
        //Tìm kiếm
        $sql="SELECT * FROM teachers WHERE name like '%$key%' Or email like '%$key%' Or phone like '%$key%' Or subject like '%$key%'";
    }
    else{
