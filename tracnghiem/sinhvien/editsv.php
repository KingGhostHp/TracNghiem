...
?>
            <div class='content2'>
                <form method='post' action='updatesv.php'>
                    <br>
                    <h1 style='color:chocolate;text-align: center;width:px;padding:10px 0px 0px 100px;font-weight:bold'>
                        Sửa thông tin sinh viên</h1>
                    <br>
                    <br>
                    <input type='hidden' name='sid' value="<?php echo $id?>" id=''>
                    <div class='form-inline'>
                        <label class='btn btn-warning' style='width: 90px;' for='name'>Họ và tên:</label>&nbsp;
                        <input style='width: 250px;' type='text' id='full_name' name='full_name'
                            value="<?php echo $row['full_name']?>" class='form-control'>&nbsp;&nbsp;&nbsp;
                        <label class='btn btn-warning' style='width: 90px;' for='email'>Email:</label>&nbsp;
                        <input style='width: 250px;' type='text' id='email' name='email'
                            value="<?php echo $row['email']?>" class='form-control'>
                    </div>
                    <br>
                    <div class='form-inline'>
                        <label class='btn btn-warning' style='width: 90px;' for='subject'>Phone:</label>&nbsp;
                        <input style='width: 250px;' type='text' id='phone' name='phone'
                            value="<?php echo $row['phone']?>" class='form-control'>&nbsp;
                        &nbsp;
                        &nbsp;
                        <label class='btn btn-warning' style='width: 90px;' for='phone'>Địa chỉ:</label>&nbsp;
                        <input style='width: 250px;' type='text' id='address' name='address'
                            value="<?php echo $row['address']?>" class='form-control'>
                    </div>
                    <br>
                    <div class='form-inline'>
                        <label class='btn btn-warning' style='width: 90px;' for='subject'>Gender:</label>&nbsp;
                        <select style='width: 100px;' name='gender' id='gender' value="<?php echo $row['gender']?>"
                    ...
                    <div class='form-outline'>
                        <button style='border:1px ridge darkorange;' class='btn btn-info'>Cập nhật</button>
                    </div>
                </form>
            </div>
        </div>
